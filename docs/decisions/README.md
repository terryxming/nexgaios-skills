...
- 每篇**必含**:状态、背景、决策、证据(附来源 URL)、影响、存疑/待验证。
...
- [0014 三种呈现正文一律逐字，区分重写与编排（扩展 0013 作用域）](0014-verbatim-body-all-presentations.md)（被 0015 取代）
- [0015 以证据约束的忠实提炼取代全文逐字](0015-evidence-grounded-distillation.md)
